    ...
    <div class="overlay">
      ...
      <div class="con">
        ...
        <div class="field-set">
          ...
          <!-- Password write again--><span class="input-item"><i class="fa fa-key"></i></span>
          <!-- Password write again-->
          <input class="form-input" id="pwdrt" type="password" placeholder="Password Retype" name="passwordretype" required="">
          <!-- Show/hide password--><span><i class="fa fa-eye" id="eye_two" aria-hidden="true" type="button"></i></span><br>
          <!-- buttons-->
          <!-- button sign-up-->
        ...
        <div class="other">
          <!-- Sign Up button-->
          <button class="btn submits login"><a href="{{route('login')}}"> Login                             </a></button>
